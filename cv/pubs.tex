...
\textbf{Synchronization Schemas: Safe Parallelization for Data Stream Processing}. \\
...
\begin{minipage}{\textwidth}
\textbf{An Order-aware Dataflow Model for Extracting Shell Script Parallelism}. \\
Shivam Handa, Konstantinos Kallas, Nikos Vasilakis, and Martin Rinard. \\
\emph{In submission}.
\end{minipage}

\begin{minipage}{\textwidth}
\textbf{The Once and Future Shell}. \\
