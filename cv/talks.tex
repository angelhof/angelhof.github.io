...
\textbf{If Practice Won't Come to Theory, Then Theory Must Go to Practice: How to Analyze and Optimize Shell Scripts}. \hfill {\em 2026}\\
Event: Invited talk @ Rajeevfest (FLOC).
\end{minipage}

\begin{minipage}{\textwidth}
\textbf{Agents, effects, and how to protect yourself against them}. \hfill {\em 2026}\\
Event: Invited talk @ University of Washington.\\
 Host: Ratul Mahajan.
\end{minipage}

\begin{minipage}{\textwidth}
\textbf{Agents, effects, and how to protect yourself against them}. \hfill {\em 2026}\\
Event: Invited talk @ Microsoft Research RiSE.\\
 Host: Shraddha Barke.
\end{minipage}

\begin{minipage}{\textwidth}
\textbf{Agents, effects, and how to protect yourself against them}. \hfill {\em 2026}\\
Event: Invited talk @ AWS Automated Reasoning Group.\\
 Host: Felipe Monteiro.
\end{minipage}

\begin{minipage}{\textwidth}
\textbf{Agents, effects, and how to protect yourself against them}. \hfill {\em 2026}\\
Event: Invited talk @ Google SRG.\\
 Host: Lily Tsai.
\end{minipage}
