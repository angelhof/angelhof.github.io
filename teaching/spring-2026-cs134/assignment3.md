...
--- FAIL: TestBasic (30.75s)
=== RUN   TestDeaf
Test: Deaf proposer ...
    test_test.go:64: too few decided; seq=0 ndecided=0 wanted=5
--- FAIL: TestDeaf (30.75s)
...
</pre>
<p>
    For now, ignore the "type Paxos has no exported methods" errors.
</p>
...
Test: Minority proposal ignored ...
  ... Passed
--- PASS: TestOld (0.02s)
=== RUN   TestManyUnreliable
Test: Many instances, unreliable RPC ...
  ... Passed
--- PASS: TestManyUnreliable (3.52s)
=== RUN   TestPartition
...
Test: One peer switches partitions, unreliable ...
  ... Passed
--- PASS: TestPartition (6.36s)
=== RUN   TestLots
Test: Many requests, changing partitions ...
  ... Passed
--- PASS: TestLots (25.18s)
PASS
ok  	cs134-25s-kv/paxos	55.941s
</pre>
