...
<h3 class="page-heading">Due date: Friday June 05, 10pm</h3>
...
Test: Basic leave/join ...
    test_test.go:36: wanted 1 groups, got 0
--- FAIL: TestBasic (0.01s)
=== RUN   TestUnreliable
Test: Concurrent leave/join, failure ...
    test_test.go:36: wanted 20 groups, got 0
--- FAIL: TestUnreliable (0.00s)
=== RUN   TestFreshQuery
Test: Query() returns latest configuration ...
    test_test.go:365: Query(-1) produced a stale configuration
...
Test: Minimal transfers after leaves ...
  ... Passed
--- PASS: TestBasic (1.11s)
=== RUN   TestUnreliable
Test: Concurrent leave/join, failure ...
  ... Passed
--- PASS: TestUnreliable (0.46s)
=== RUN   TestFreshQuery
Test: Query() returns latest configuration ...
  ... Passed
...
<p>
    ...
    A real system would need to do so, but this assignment doesn't require it.
...
Test: Basic Join/Leave ...
  ... Passed
--- PASS: TestBasic (6.15s)
=== RUN   TestMove
Test: Shards really move ...
  ... Passed
--- PASS: TestMove (15.73s)
=== RUN   TestLimp
...
Test: Concurrent Put/Get/Move ...
  ... Passed
--- PASS: TestConcurrent (1.72s)
=== RUN   TestConcurrentUnreliable
...
<p>
    ...
    rerun the autograder on your submission or increase the timeout at any time, including after the late submission deadline.
    <strong>Please start early as the autograder may take up to 45 minutes to run!</strong>
</p>

<hr>

<address>
    Please post questions on <a href="https://piazza.com/ucla/spring2026/cs134">Piazza</a>.
</address>
